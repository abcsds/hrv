...
SDNN_WINDOW_SIZE = 30 # Number of points taken into account for the std
...
def animate(frame):
    global hr_data_buffer, rr_data_buffer, nn_data_buffer, sdnn_data_buffer, last_rr, poincare_x, poincare_y, initial_timestamp
    ...
    line_nn.set_ydata(nn_data_buffer)
    ...
    print(f"    PNN50: {pnn50:.4f}, SDNN: {this_sdnn:.4f}")
